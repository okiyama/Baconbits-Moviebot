...
"""
See README on github, for full details. Here's some copy-pasta.
Instructions:
Download python-irclib-0.4.8 and run "python setup.py install" to install the irclib needed.
Run "python MovieNight_IrcBot.py irc.us.baconbits.org:6667 #movienight MovieBot" which will have the bot join #movienight under the name MovieBot. It will also leave #lounge, since all public chat that MovieBot does it sent to all channels it is in.
...
announce - Says the name of everyone in the channel to give their IRC client a ping, recommended to get users in before you start.
start - Immediately begins a countdown from 10 to 0 at which point all the users press play.
